...
func BusHandler(c *gin.Context) {
	...
	case "DeleteBus":service.RemoveBus(c.Request,c.Writer)
	case "BusList":service.BusList(c.Request,c.Writer)
	case "UpdateBus":service.UpdateBus(c.Request,c.Writer)
	case "ViewBusInfo":service.ViewBusInfo(c.Request,c.Writer)
	default: {
